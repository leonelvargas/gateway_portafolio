...
$conn = mysqli_connect("localhost","admin_basegaten","39496625leo","admin_basegaten");
...
$query = "SELECT * FROM `msj_data_new_enviado` WHERE `devices_serie` IN($matches)";
...
$query = "SELECT * FROM `msj_data_new_recibido` WHERE `devices_serie` IN($matches)";
$result = $conn->query($query);
//print_r($result);
//die();
            ...
            <div class="col-xs-12 col-sm-9">
             <div class="box p-a">
              <div class="form-group">
                ...
                <!-- VALORES EN TIEMPO REAL/primera tabla -->
                <div class="row">
                  <div class="col-sm-9">
                        <div class="box">
                          <div class="box-header">
                            <h2>Mensajes enviados desde el Gateway</h2>
                            <small>
                              Base de Datos del usuario: <?php echo $_SESSION['users_email'] ?>.
                            </small>
                          </div>
                          <table class="table table-striped b-t">
                            ...
                            <tbody>
                              ...
                              <?php foreach ($traffics as $traffic ): ?>
                                <tr>
                                  <td><?php echo $traffic['msj_data'] ?></td>
                                  <td><?php echo $traffic['msj_date'] ?></td>
                                </tr>
                              <?php endforeach; ?>
              ...
              <!-- VALORES EN TIEMPO REAL/segunda tabla -->
                          <div class="row">
                            <div class="col-sm-9">
                                  <div class="box">
                                    <div class="box-header">
                                      <h2>Mensajes recibidos desde el Gateway</h2>
                                      <small>
                                        Base de Datos del usuario: <?php echo $_SESSION['users_email'] ?>.
                                      </small>
                                    </div>
                                    <table class="table table-striped b-t">
                                      ...
                                      <tbody>
                                        ...
                                        <?php foreach ($messages as $message ): ?>
                                          <tr>
                                            <td><?php echo $message['msj_data'] ?></td>
                                            <td><?php echo $message['msj_date'] ?></td>
                                          </tr>
                                        <?php endforeach; ?>
...
const WebSocket_URL = 'wss://gatewaymultip.ml:8094/mqtt'
...
client.on('connect', () => {
  ...
  <?php foreach ($devices as $device) { ?>
    client.subscribe('<?php echo $device['devices_serie'] ?>/insert_data_query', { qos: 0 }, (error) => {})
  <?php } ?>
